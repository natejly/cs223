/*
 * Filename: RBTree.h
 * Contains: Interface of Red-Black Trees for CPSC 223
...
public:
    ...
    /**
     * Reports whether this is a valid Red-Black Tree
     *
     * @param this the tree
     * @return true if this is a valid Red-Black Tree, false otherwise
     */
    bool is_valid() const;
